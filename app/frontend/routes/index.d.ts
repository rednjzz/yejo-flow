 ...
 * @returns {string} route path
 */
export const contractContractItemsPath: ((
  contractId: RequiredRouteParameter,
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export const projectContractsPath: ((
