...
- Integration patterns: RESTful resources with Inertia responses (Inertia pages for navigation, partial reloads for targeted updates, Action Cable for real-time)
